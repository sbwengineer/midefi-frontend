      ...
      <v-col :class="colSize">
        ...
        <section>
          ...
          <p>
            ...
            MIDefi blockchain. This means that at the time of this guide’s writing, the only types
            of assets that <strong>MIDefi</strong> can support are rBTC and ERC-20 tokens deployed
            on MIDefi.
          </p>
          <p>
        ...
        <section>
          ...
          <p>
            ...
            to another user, the <strong>MIDefi Protocol</strong> aggregates the supply of each
        ...
        <section>
          ...
          <p>
            ...
            <em>for use anywhere in the MIDefi ecosystem</em>. Unlike peer-to-peer protocols,
            borrowing from <strong>MIDefi</strong> simply requires a user to specify a desired
            asset; there are no terms to negotiate, maturity dates, or funding periods;
        ...
        <section>
          ...
          <p>
            When users and applications supply an asset to the <strong>MIDefi Protocol</strong>,
        ...
        <section>
          ...
          <p>
            ...
            <strong>MIDefi</strong>’s governance system. The liquidation incentive means that
        ...
        <section>
          ...
          <p>
            The <strong>MIDefi protocol</strong> does not support specific tokens by default;
          ...
          <p>
            ...
            (such as choosing the <a href="/docs/keyConcepts#interestModel">interest rate</a> model
