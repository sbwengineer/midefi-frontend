    ...
    <v-row>
      ...
      <v-col :class="colSize">
        ...
        <section>
          ...
          <p>
            <strong>MIDefi</strong> deposits are easy! After you have connected your Metamask or
        ...
        <section>
          ...
          <p>
            ...
            that borrow crypto assets from the <strong>MIDefi</strong> protocol pay a varying
            <a href="/docs/keyConcepts#interestModel">interest rate</a>
            every rBTC block. The interest that borrowers pay produces the interest that suppliers
            earn.
          </p>
          <p>
        ...
        <section>
          ...
          <p>
            ...
            changes. This impacts several aspects of the protocol (liquidity, price, indexes, etc).
            If you want to check the current status of a market, you should go to the
